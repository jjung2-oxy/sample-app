...
export const QuestionInput = ({ onSend, disabled, placeholder, clearOnSend, conversationId, value, onChange }: Props) => {
  const [question, setQuestion] = useState<string>(value || '')
